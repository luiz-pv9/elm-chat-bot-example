							...
							switch (_p5.ctor) {
								...
								case 'Label':
									return {
										...
										_0: {
											id: _p5._0,
											recipes: A2(_elm_lang$core$List$drop, index, blueprint.recipes)
										},
										_1: {ctor: '[]'}
									};
								default:
...
var _user$project$Bot$TextInput = {ctor: 'TextInput'};
	...
	function (recipe, session) {
		...
		switch (_p7.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					session,
					{inputState: _user$project$Bot$Ended});
		}
	});
var _user$project$Bot$sessionWithProfile = F2(
	function (blueprint, attributes) {
		return {
...
var _user$project$Bot$updateUserInput = F2(
			...
			return _elm_lang$core$Native_Utils.update(
				session,
				{
					messages: A2(
						...
						{
							ctor: '::',
							_0: {sentBy: _user$project$Bot$User, body: _p8._0},
							_1: {ctor: '[]'}
						})
				});
		} else {
...
var _user$project$Bot$update = F2(
	function (msg, session) {
		...
		while (true) {
			...
			var nextSession = A2(
				_user$project$Bot$updateUserInput,
				msg,
				A2(
					_user$project$Bot$updateInputState,
					recipe,
					_elm_lang$core$Native_Utils.update(
						session,
			...
			if (A2(_user$project$Bot$shouldWait, msg, recipe)) {
				...
				var _v11 = _user$project$Bot$Run,
					_v12 = A3(_user$project$Bot$advanceSession, msg, recipe, nextSession);
				msg = _v11;
				session = _v12;
				continue update;
			}
...
var _user$project$Bot$Label = function (a) {
	return {ctor: 'Label', _0: a};
};
var _user$project$Bot$label = F2(
	function (botId, blueprint) {
		return _elm_lang$core$Native_Utils.update(
			blueprint,
			{
				recipes: A2(
					...
					blueprint.recipes,
					{
						ctor: '::',
						_0: {
							action: _user$project$Bot$Label(botId)
						},
						_1: {ctor: '[]'}
					})
			});
...
var _user$project$Bot$GoTo = function (a) {
	return {ctor: 'GoTo', _0: a};
};
var _user$project$Bot$goTo = F2(
	function (botId, blueprint) {
		return _elm_lang$core$Native_Utils.update(
			blueprint,
			{
				recipes: A2(
					...
					blueprint.recipes,
					{
						ctor: '::',
						_0: {
							action: _user$project$Bot$GoTo(botId)
						},
						_1: {ctor: '[]'}
					})
			});
...
var _user$project$Main$viewChatMessage = F2(
	function (name, message) {
		var _p0 = message.sentBy;
		if (_p0.ctor === 'Bot') {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('inline-block rounded-r-lg py-2 pl-2 pr-4 bg-blue text-white mb-2'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('text-sm'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Robot'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('inline-block rounded-l-lg py-2 pl-2 pr-4 bg-orange text-white mb-2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$viewIdentificationFooter = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('text-xs text-grey text-center'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Built by '),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://onaboutcode.com'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('text-grey-dark'),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Luiz Paulo'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$viewIdentificationHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('bg-indigo p-8 text-white rounded-t-lg'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('font-bold text-xl block'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Welcome to Elm Chat Bot'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('If you\'re interested, '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('text-white'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$target('_blank'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://github.com/luiz-pv9/elm-chat-bot-example'),
								_1: {ctor: '[]'}
							}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('checkout the code'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$viewIdentificationLabel = F3(
	function (id, labelText, validation) {
		var msg = function () {
			var _p1 = validation;
			if (_p1.ctor === 'Nothing') {
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('ml-2 text-sm text-red italic'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {name: a, email: b, currentPage: c, validationMessage: d, message: e};
	});
var _user$project$Main$AskForEmail = {ctor: 'AskForEmail'};
var _user$project$Main$AskForName = {ctor: 'AskForName'};
...
var _user$project$Main$init = function (_p2) {
	var _p3 = A2(
		...
		A2(
			...
			_user$project$Main$root,
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'email', _1: 'luiz@onaboutcode.com'},
					_1: {ctor: '[]'}
				}
			}));
	var session = _p3._0;
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$emptyModel(session),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$BotMsg, cmd)
	};
};
var _user$project$Main$updateBotSession = F3(
	function (msg, session, model) {
		var _p4 = A2(_user$project$Bot$update, msg, session);
		var nextSession = _p4._0;
		var cmd = _p4._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					currentPage: _user$project$Main$ChatPage(nextSession)
				}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$BotMsg, cmd)
		};
	});
var _user$project$Main$updateBotMsg = F2(
	function (botMsg, model) {
		var _p5 = model.currentPage;
		if (_p5.ctor === 'ChatPage') {
			return A3(_user$project$Main$updateBotSession, botMsg, _p5._0, model);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$buildBotSessionFromModel = function (model) {
	var _p6 = A2(
		_user$project$Bot$update,
		_user$project$Bot$Run,
		A2(
	...
	var newSession = _p6._0;
	var cmd = _p6._1;
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$ChatPage(newSession),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$BotMsg, cmd)
	};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			...
			case 'AttemptToTransitionToEmail':
				var _p8 = (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(model.name),
					0) > 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Nothing,
					_1: _user$project$Main$IdentificationPage(_user$project$Main$AskForEmail)
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Just('Please fill in your name'),
					_1: _user$project$Main$IdentificationPage(_user$project$Main$AskForName)
				};
				var validation = _p8._0;
				var nextPage = _p8._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentPage: nextPage, validationMessage: validation}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AttemptToTransitionToChat':
				var _p9 = (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$String$length(model.email),
					0) > 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Nothing,
					_1: _user$project$Main$buildBotSessionFromModel(model)
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Just('Please fill in your email'),
					_1: {
						ctor: '_Tuple2',
						_0: _user$project$Main$IdentificationPage(_user$project$Main$AskForEmail),
						_1: _elm_lang$core$Platform_Cmd$none
					}
				};
				var validation = _p9._0;
				var nextPage = _p9._1._0;
				var cmd = _p9._1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				var _p10 = A2(_user$project$Main$updateBotMsg, _p7._0, model);
...
var _user$project$Main$viewChatOptions = function (options) {
	var viewOption = function (option) {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bg-indigo text-white text-sm py-1 px-2 rounded-full mr-2 font-bold'),
				_1: {
					ctor: '::',
	...
	return A2(_elm_lang$core$List$map, viewOption, options);
};
...
var _user$project$Main$viewChatInput = F2(
	function (textMessage, state) {
		var _p11 = state;
		switch (_p11.ctor) {
			case 'Blocked':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('hang on'),
						_1: {ctor: '[]'}
					});
			case 'TextInput':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetMessage),
						_1: {
							ctor: '::',
							_0: _user$project$Main$onEnter(_user$project$Main$SendMessage),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('border-2 rounded p-2 block w-full'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(textMessage),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('Hit enter to send'),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			case 'Options':
				return A2(
					...
					_user$project$Main$viewChatOptions(_p11._0));
			default:
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Thanks for using this amazing bot'),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Main$viewChat = F2(
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewChatMessage(model.name),
						session.messages)),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$viewChatInput, model.message, session.inputState),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$AttemptToTransitionToChat = {ctor: 'AttemptToTransitionToChat'};
var _user$project$Main$AttemptToTransitionToEmail = {ctor: 'AttemptToTransitionToEmail'};
var _user$project$Main$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$project$Main$viewIdentificationAskForEmail = F2(
	function (email, validation) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$viewIdentificationHeader,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('w-full p-8'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A3(_user$project$Main$viewIdentificationLabel, 'email', 'What\'s your email address?', validation),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('bg-grey-light p-3 rounded block w-full'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('e.g., luna@hogwarts.com'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetEmail),
															_1: {
																ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('absolute pin-t pin-r mt-3 mr-2 text-sm text-blue-dark font-bold'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AttemptToTransitionToChat),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Start chat'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewIdentificationFooter,
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Main$viewIdentificationAskForName = F2(
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_user$project$Main$viewIdentificationLabel, 'name', 'What\'s your name?', validation),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('e.g., Luna Lovegood'),
														_1: {
															ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AttemptToTransitionToEmail),
														_1: {ctor: '[]'}
													}
												},
												{
...
var _user$project$Main$viewIdentification = F2(
	function (step, model) {
		var _p12 = step;
		if (_p12.ctor === 'AskForName') {
			return A2(_user$project$Main$viewIdentificationAskForName, model.name, model.validationMessage);
		} else {
			return A2(_user$project$Main$viewIdentificationAskForEmail, model.email, model.validationMessage);
		}
	});
var _user$project$Main$view = function (model) {
	var _p13 = model.currentPage;
	if (_p13.ctor === 'IdentificationPage') {
		return A2(_user$project$Main$viewIdentification, _p13._0, model);
	} else {
		return A2(_user$project$Main$viewChat, _p13._0, model);
	}
};
